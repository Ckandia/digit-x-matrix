...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, BULK_TRADER } = DBOT_TABS;
    ...
    // BULK_TRADER was missing here, which is why the Summary/Journal/Transactions
    // panel vanished on the Bulk Trades tab — the component returned null.
    const show_run_panel = [BOT_BUILDER, CHART, BULK_TRADER].includes(active_tab) || active_tour;
